...
import dmrghandler.src.dmrghandler.energy_extrapolation as energy_extrapolation
import dmrghandler.src.dmrghandler.hdf5_io as hdf5_io
import dmrghandler.src.dmrghandler.qchem_dmrg_calc as qchem_dmrg_calc
...
def dmrg_central_loop(
    ...
    fit_parameters_list = []
    log.info(f"Energy change: {np.abs(energy_change)}")
    while (
